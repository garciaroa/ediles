  ...
  <div class="row">
    ...
    <div class="row">
      ...
      <div class="col">
        ...
        <form action="/admin/actualizarComuna" method="post" enctype="multipart/form-data">
                    @csrf
                <input type="hidden" name="idComuna" id="idComuna" value="{{ $result['comuna'][0]->id_comuna}}">
                ...
                <div class="form-group col-md-2"></div>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" value="{{ $result['comuna'][0]->nombre_comuna }}" name="inputComuna" class="form-control form-control-sm is-valid" id="inputComuna" required>

                    <div class="valid-feedback">
                      Ingrese Nombre de la Nueva Comuna!
                    </div>
