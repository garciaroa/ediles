  ...
  <div class="row">
    ...
    <div class="row">
      ...
      <div class="col">
        ...
        <form action="/admin/actualizarBarrio" method="post" enctype="multipart/form-data">
                    @csrf
            <input type="hidden" value="{{ $results['barrio'][0]->id_barrio }}" name="idBarrio" id="idBarrio" >        
            <div class="form-row">
                  ...
                  <select name="selectComuna" class="form-control form-control-sm is-valid" id="selectComuna" aria-describedby="validationServer04Feedback" required>
                    <option selected disabled value="">Seleccione...</option>
                      @foreach( $results['comunas'] as $comuna)
                          <option value="{{ $comuna->id_comuna }}"  @if( $comuna->id_comuna == $results['barrio'][0]->cod_comuna) selected @endif>{{ $comuna->nombre_comuna }}</option>
                      @endforeach    
                    <option value="0">N/A</option>
                  </select>
                  <div class="valid-feedback">
            ...
            <div class="form-row">
              <div class="form-group col-md-2"></div>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" value="{{ $results['barrio'][0]->nombre_barrio}}" name="inputBarrio" class="form-control form-control-sm is-valid" id="inputBarrio" required>
              ...
              <div class="col-md-2"></div>
                <div class="col-md-6">
                  <div class="box-footer text-center">
                    <button type="submit" class="btn btn-primary">Editar Barrio</button>
