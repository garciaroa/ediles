...
<div>
  ...
  <section class="content-header" style="margin-top: -1em;">
    ...
    <ol class="breadcrumb float-right font-italic">
      ...
      /<li class="active">{{ trans('labels.NuevoProyectoooo') }}</li>
    </ol>
  </section>
    ...
    <div class="row">
      ...
      <div class="col">
        ...
        <div class="tabbable" id="tabs-994657">
          ...
          <form action="/admin/actualizarProyecto" method="post" enctype="multipart/form-data">
          @csrf
          <input name="id_proyecto" id="id_proyecto" type="hidden" value="{{ $result['proyectos'][0]->id_proyecto }}">
              ...
              <div class="tab-pane active" id="cronograma">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <div class="input-group date fechas">
                      <input type="text" value=" {{date('d/m/Y', $result['proyectos'][0]->fechaCalificacionOferta)}} " name="inputPlazoCalificacion" class="form-control form-control-sm is-valid" id="inputPlazoCalificacion" required><span class="input-group-addon "><i class="bi bi-calendar3"></i></span>
                    </div>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <div class="input-group date fechas">
                      <input type="text" value="{{date('d/m/Y', $result['proyectos'][0]->fechaAviso)}}" name="inputPublicacionAviso" class="form-control form-control-sm is-valid" id="inputPublicacionAviso" required><span class="input-group-addon "><i class="bi bi-calendar3"></i></span>
                    </div>
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <div class="input-group date fechas">
                      <input type="text" value="{{date('d/m/Y', $result['proyectos'][0]->fechaPublicacionAviso)}}" name="inputPublicacionAvisoPublico" class="form-control form-control-sm is-valid" id="inputPublicacionAvisoPublico" required><span class="input-group-addon "><i class="bi bi-calendar3"></i></span>
                    </div>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <div class="input-group date fechas">
                      <input type="text" value="{{date('d/m/Y', $result['proyectos'][0]->fechaPlazoObservaciones)}}" name="inputPlazoObservaciones" class="form-control form-control-sm is-valid" id="inputPlazoObservaciones" required><span class="input-group-addon "><i class="bi bi-calendar3"></i></span>
                    </div>
              ...
              <div class="tab-pane" id="ubicacion">
                ...
                <div class="form-row capa" id="capa">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" value="{{ $result['proyectos'][0]->direccion_proyecto }}" name="inputEjecucion" class="form-control form-control-sm is-valid" id="inputEjecucion" required>
                ...
                <fieldset class="border p-2">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" value="{{ $result['proyectos'][0]->coordenadaX_proyecto }}" name="inputCoordenada1" class="form-control form-control-sm is-valid" id="inputCoordenada1" required>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" value="{{ $result['proyectos'][0]->coordenadaY_proyecto }}" name="inputCoordenada2" class="form-control form-control-sm is-valid" id="inputCoordenada2" required>
              ...
              <div class="tab-pane" id="informacion">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" value="{{ $result['proyectos'][0]->codigo_proyecto }}" name="inputNumeroProceso" class="form-control form-control-sm is-valid" id="inputNumeroProceso" required>
                    <div class="valid-feedback">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" value="{{ $result['proyectos'][0]->nombre_proyecto }}" name="inputTitulo" class="form-control form-control-sm is-valid" id="inputTitulo" required>
                    <div class="valid-feedback">
                      Ingrese Titulo!
                    </div>
              ...
              <div class="tab-pane" id="obra">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input name="inputTipoContrato" value="{{ $result['proyectos'][0]->tipo_proyecto }}" type="text" class="form-control form-control-sm is-valid" id="inputTipoContrato" required>
                    <div class="valid-feedback">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <textarea name="textareaDescripcion" class="form-control" id="textareaDescripcion" rows="3" required>{{ $result['proyectos'][0]->descripcion_proyecto }}</textarea>
                    <div class="valid-feedback">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input name="inputDuracionContrato" value="{{ $result['proyectos'][0]->duracion_proyecto }}" type="text" class="form-control form-control-sm is-valid" id="inputDuracionContrato" required>
                    <div class="valid-feedback">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input name="inputValorEstimado" value="{{ $result['proyectos'][0]->presupuesto }}" type="text" class="form-control form-control-sm is-valid" id="inputValorEstimado" required>
                    <div class="valid-feedback">
