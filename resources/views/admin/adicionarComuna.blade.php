  ...
  <div class="row">
    ...
    <div class="row">
      ...
      <div class="col">
        ...
        <form action="/admin/adicionarNuevaComuna" method="post" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="form-group col-md-2"></div>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" name="inputComuna" class="form-control form-control-sm is-valid" id="inputComuna" required>
