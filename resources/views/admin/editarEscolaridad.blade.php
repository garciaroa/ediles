  ...
  <div class="row">
    ...
    <div class="row">
      ...
      <div class="col">
        ...
        <form action="/admin/actualizarEscolaridad" method="post" enctype="multipart/form-data">
                    @csrf
                <input type="hidden" name="idEscolaridad" id="idEscolaridad" value="{{ $result['escolaridad'][0]->id_escolaridad}}">
                ...
                <div class="form-group col-md-2"></div>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" value="{{ $result['escolaridad'][0]->nombre_escolaridad }}" name="inputEscolaridad" class="form-control form-control-sm is-valid" id="inputEscolaridad" required>
              ...
              <div class="col-md-2"></div>
                <div class="col-md-6">
                  <div class="box-footer text-center">
                    <button type="submit" class="btn btn-primary">Actualizar Escolaridad</button>
