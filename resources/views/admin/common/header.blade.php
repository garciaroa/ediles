...
<input type="text" id="idcafeteria" name="idcafeteria" value="{{ Auth::user()->myid }}" style="display:none;" >
    <!-- Logo -->
...
"></div>
      ...
      <div class="navbar-custom-menu">
        ...
        @if( Auth::user()->adminType == 1 || Auth::user()->adminType == 22)
          {{--dd(Auth::user()->myid)--}}
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                @foreach($unseenOrders as $unseenOrder)
                  <li><!-- start message -->
                    <a href="{{ URL::to("admin/viewOrder")}}/{{ $unseenOrder->orders_id}}" alt="ver Ordenes">
                      <div class="pull-left">
